class Light {
    ...
    init() {
        ...
        this.light = new THREE.SpotLight(0xffff00, 1, 500, Math.PI / 4)
        ...
        this.kulka2 = new THREE.Mesh(this.geometria, this.material2)

        this.container.add(this.kulka2);

        this.light.target = this.kulka2
